...
| M1-A | Synthetic parameter recovery | Hard | 50x1000 synthetic experiment | b RMSE <0.15; theta Spearman >0.98 | UNRESOLVED | | Blocked by M0 order |
| M1-B | Reference implementation agreement | Hard | Real-matrix comparison | Within Monte Carlo error vs girth or py-irt | UNRESOLVED | | Blocked by M0 order |
...
| ENG | Package quality | Hard | `pytest`, `ruff`, `mypy --strict` | All pass; no network calls in tests | UNRESOLVED | | Establish M0 tooling |
