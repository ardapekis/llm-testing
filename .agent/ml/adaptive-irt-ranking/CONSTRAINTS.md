...
| M1-B | Reference implementation agreement | Hard | Full 134x500 SWE matrix; local 1PL vs girth 0.8.0; 100 paired bootstraps | b Spearman >0.99; observed b RMSE <= bootstrap q95; all local bootstrap fits converge | UNRESOLVED | `configs/m1_reference_agreement.json` | Run from clean preregistration revision |
