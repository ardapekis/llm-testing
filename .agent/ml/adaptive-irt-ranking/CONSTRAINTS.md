...
| M1-B-v2 | Corrected lightweight reference implementation agreement | Hard | Validate full SWE artifact; salted-hash sample of 64 estimable items; local vs girth joint 2PL MML; Stocking-Lord link; 4 theta~N(0,1) replicates | >=90% estimable; b rho >0.98; a rho >0.95; observed b/log-a/ICC RMSE each <= bootstrap q95 | UNRESOLVED | `configs/m1_reference_agreement_v2.json` | Run from clean preregistration revision |
